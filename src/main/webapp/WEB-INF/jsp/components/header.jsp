    ...
    <%@ taglib prefix="sf" uri="http://www.springframework.org/tags/form" %>
        <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
            <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	                    ...
	                    <div class="navbar-collapse collapse ps-3" id="navs">
	                        ...
	                        <form class="form-inline my-2 my-md-0 row p-5 w-100" method="get" action="/search">
	                            <div class="input-group">
	                                <button type="submit" class="btn btn-success input-group-text bi bi-search"></button>
				...
				<sec:authorize access = "!isAuthenticated()">
					 <nav class="navbar navbar-expand-lg navbar-light py-3" style="background-color: #e7f2ed;">

	                    <a href="/" class="navbar-brand ms-2 me-5 pe-5" style="min-width:1vw; display:inline-block;">
	                        <img src="images/UIF_summative_Logo.png" class="ms-2" style="height:5vw;" />
	                        <h1 class="h2 d-inline-block text-success text-uppercase">ABC Jobs</h1>
	                    </a>
	
	                    <button class="navbar-toggler collapsed" style="top:5vw; right:5vw;" type="button" data-bs-toggle="collapse" data-bs-target="#navs" aria-controls="navs" aria-expanded="false" aria-label="Toggle Navigation">
					        <span class = "navbar-toggler-icon"></span>
					    </button>
	                    <div class="navbar-collapse collapse ps-3" id="navs">
	                        <ul class="navbar-nav mx-auto me-5 mt-4">
	                            ...
	                            <li class="nav-item mx-2">
	                                <a href="login" class="nav-link text-success h5">Sign In</a>
	                            </li>
	                            <li class="nav-item mx-2">
	                                <a href="Register" class="nav-link text-success h5">Get Started</a>
	                            </li>
	                        </ul>
